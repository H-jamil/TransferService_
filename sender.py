...
from search import  base_optimizer, brute_force, hill_climb, cg_opt, gradient_opt_fast, binary_search, fixed_cc
...
def run_transfer():
    ...
    elif configurations["method"].lower() == "fixed":
        log.info("Running a fixed configurations  .... ")
        params = fixed_cc(configurations, sample_transfer, log)
    else:
